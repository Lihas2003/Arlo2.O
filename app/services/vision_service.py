...
- Answer the user's specific question directly (e.g. "what am I holding") with concrete, specific answers. Lead with the answer, then add brief context if necessary.
...
- Be confident and specific. If you see a phone, say "a phone" and what kind if visible. If you see a person, describe them.
    ...
    def __init__(self):
        ...
        if GROQ_API_KEYS:
            try:
                ...
                logger.warning("[VISION] Groq client int failed: %s", e)
